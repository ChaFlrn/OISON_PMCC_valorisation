...
L'évolution du nombre de saisies par groupe d'espèces est représentée par les deux graphiques ci-dessous :
...
flextable(groupes_espece_tableau) %>%
  ...
  set_caption( caption = paste("Nombre de saisies par groupe d'espèces \nen", params$annee_fin, nom_bases)) %>% 
...
L'évolution du nombre de saisies d'espèces protégées `r nom_bases`, en fonction des différents groupes, est décrite dans la tableau ci-dessous. Ce tableau décrit également la contribution départementale pour la région pour chaque groupe d'espèces pour l'année `r params$annee_fin`.
