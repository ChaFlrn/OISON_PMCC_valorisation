...
ggplot(saisies) +
  aes(x = annee, y = nombre_saisies, fill = INSEE_DEP) + # Choisir les axes du graphique et la légende
...
flextable(observateurs_tableau) %>%
  ...
  bg(part = "header", bg = "#333333") %>%
  bold(part = "header") %>% 
  align(j = 2:14, align = "right") %>%   # Aligner à droite les colonnes de saisies
  align(part = "header",j = 2:14, align = "right") %>% 
...
flextable(groupes_espece_tableau) %>%
  ...
  align(j = 2:27, align = "right") %>%   # Aligner à droite les colonnes de saisies
  align(part = "header",j = 2:27, align = "right") %>% 
